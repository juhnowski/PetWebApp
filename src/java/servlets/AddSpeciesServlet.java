...
/**
 * Сервис добавления нового биологического вида
 * @author Илья Юхновский
 */
@WebServlet(name = "AddSpeciesServlet", urlPatterns = {"/AddSpeciesServlet"})
public class AddSpeciesServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Template temp = cfg.getTemplate("addspeciesresult.ftl");
